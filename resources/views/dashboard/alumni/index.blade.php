...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow py-1">
    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="position-sticky pt-3 sidebar-sticky">
              ...
              <li class="nav-item">
                  <a class="nav-link active" href="/dashboard/alumni">
              ...
              <table class="table" id="myTable">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="/dashboard/alumni/{{ $alumni->id }}" class="badge bg-info"><i class="bi bi-eye"></i></a>
                            <a href="/dashboard/{{ $alumni->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>
