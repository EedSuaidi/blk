                    ...
                    <div class="card-body">
                        <form action="/dashboard/alumni" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror mt-1" name="nama" value="{{ old('nama') }}" placeholder="Masukkan Nama Lengkap">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('nik') is-invalid @enderror mt-1" name="nik" value="{{ old('nik') }}" placeholder="Masukkan Nomor Induk Kependudukan">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror mt-1" name="alamat" placeholder="Masukkan Alamat Lengkap" rows="3">{{ old('alamat') }}</textarea>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold mt-3">Satus</label>
